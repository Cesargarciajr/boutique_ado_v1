...
ALLOWED_HOSTS = [
    ...
    'local-host',
    'ecomerce-boutiqueado-232c595dce56.herokuapp.com',]
...
MESSAGES_STORAGE = 'django.contrib.messages.session.SessionStorage'
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config 
    AWS_STORAGE_BUCKET_NAME = 'ecomerce-boutiqueado'
    ...
    # Overrida static and media URLs in production
...
if 'DEVELOPMENT' in os.environ:
    EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'
    DEFAULT_FROM_EMAIL = 'cesargarcia.elder@gmail.com'
else:
